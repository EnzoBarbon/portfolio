import styled, { Keyframes, StyledComponent, ThemeProvider } from "styled-components";
...
interface LetterUniqueTextProps{
  ...
  specialStylesByIndex? : {[index : string] : {
    style : StyledComponent<"span", any,{},never>;
    animation : Keyframes;
  }};
}
  ...
  for (let i = 0; i < props.text.length; i++) 
{
  ...
  {
      letters.push(<div style={{width: "1rem", display: "inline-block"}}></div>);
      continue;
    }
